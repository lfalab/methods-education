...
![](../../assets/brexit_educ_scatter_line.jpg)
...
::: presenter-space
-   **C19:** How to interpret the slope precisely — and what it does and does not mean.
-   **C20:** Inference — confidence intervals and p-values for regression estimates.
-   **C21:** R-squared — how much variation in y does the model explain?
:::
...
-   Regression is the workhorse of quantitative political science.
-   It turns a visual pattern in a scatterplot into a precise, testable statement.
