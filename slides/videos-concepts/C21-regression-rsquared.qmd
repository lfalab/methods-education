...
::: presenter-space
-   C18–C20: we estimated a slope and tested whether it differs from zero.
-   A separate question: how **useful** is the model as a whole?
-   R-squared answers: how much of the variation in y does x **explain**?
:::
...
-   Residuals are large — the model misses most observations badly.
...
-   Residuals are small — predictions are close to the observed values.
...
-   About **30%** of the variation in Leave vote share across UK regions...
-   ...is explained by differences in **higher education share**.
:::
...
-   Statistical significance (C20): is the slope distinguishable from zero?
-   R-squared (C21): how much of y does the model explain?
...
-   Brexit model: R² ≈ 0.30 — education explains **30%** of Leave vote variation.
...
-   In political science, bivariate R² values are often modest — that is expected.
